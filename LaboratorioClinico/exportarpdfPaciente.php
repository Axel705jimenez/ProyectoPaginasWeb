...
$pdf->Cell(40, 10, 'calle', 1, 0, 'C');
$pdf->Cell(40, 10, 'colonia', 1, 0, 'C');
$pdf->Cell(40, 10, 'numeroExt', 1, 0, 'C');
$pdf->Cell(40, 10, 'ciudad', 1, 0, 'C');
$pdf->Cell(40, 10, 'estado', 1, 0, 'C');
$pdf->Cell(40, 10, 'correoElectronico', 1, 1, 'C');
...
$sql = "SELECT nombre, aPaterno, aMaterno, sexo, calle, colonia, numeroExt, ciudad, estado, correoElectronico FROM paciente WHERE estatus = 1";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(40, 10, $row['calle'], 1, 0, 'L');
        $pdf->Cell(40, 10, $row['colonia'], 1, 1, 'L');
        $pdf->Cell(40, 10, $row['numeroExt'], 1, 0, 'L');;
        $pdf->Cell(40, 10, $row['ciudad'], 1, 0, 'L');
        $pdf->Cell(40, 10, $row['estado'], 1, 0, 'L');
        $pdf->Cell(40, 10, $row['correoElectronico'], 1, 1, 'L');
    }
} else {
